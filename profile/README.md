...
* [litecad](https://github.com/Geo-Linux-Calculations/litecad):
![GitHub release (latest by date)](https://img.shields.io/github/v/release/Geo-Linux-Calculations/litecad)
![GitHub Release Date](https://img.shields.io/github/release-date/Geo-Linux-Calculations/litecad)
![GitHub repo size](https://img.shields.io/github/repo-size/Geo-Linux-Calculations/litecad)
![GitHub all releases](https://img.shields.io/github/downloads/Geo-Linux-Calculations/litecad/total)
* [lisp-conformal1p](https://github.com/Geo-Linux-Calculations/lisp-conformal1p):
![GitHub release (latest by date)](https://img.shields.io/github/v/release/Geo-Linux-Calculations/lisp-conformal1p)
![GitHub Release Date](https://img.shields.io/github/release-date/Geo-Linux-Calculations/lisp-conformal1p)
![GitHub repo size](https://img.shields.io/github/repo-size/Geo-Linux-Calculations/lisp-conformal1p)
![GitHub all releases](https://img.shields.io/github/downloads/Geo-Linux-Calculations/lisp-conformal1p/total)
![GitHub](https://img.shields.io/github/license/Geo-Linux-Calculations/lisp-conformal1p)
...
* [seditor](https://github.com/Geo-Linux-Calculations/seditor):
![GitHub release (latest by date)](https://img.shields.io/github/v/release/Geo-Linux-Calculations/seditor)
![GitHub Release Date](https://img.shields.io/github/release-date/Geo-Linux-Calculations/seditor)
![GitHub repo size](https://img.shields.io/github/repo-size/Geo-Linux-Calculations/seditor)
![GitHub all releases](https://img.shields.io/github/downloads/Geo-Linux-Calculations/seditor/total)
